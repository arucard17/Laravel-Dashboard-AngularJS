<div class="row">
    <div class="col-lg-8 center-col">
        <div class="widget">
            <div class="widget-header">Nuevo Artículo</div>
                ...
                <div class="col-lg-12 form-container">
                    <form role="form" name="form" ng-submit="submit()" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <textarea id="text" name="text" ng-model="article.text" class="form-control" required>
                                </textarea>
                                <div class="error-container" ng-show="form.url.$dirty && form.url.$invalid">
                                <p ng-show="form.url.$error.required" class="help-block">El texto es obligatorio.</p>
                                <p ng-show="form.url.$error.backend" ng-bind="b.errors.text[0]" class="help-block"></p>
                            </div>
                            </div>
                        </div>
